    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>
            {agendamentoEntity.dataHora ? <TextFormat value={agendamentoEntity.dataHora} type="date" format={APP_DATE_FORMAT} /> : null}
          </dd>
          <dt>Servico</dt>
          <dd>{agendamentoEntity.servico ? agendamentoEntity.servico.id : ''}</dd>
          <dt>User</dt>
          <dd>{agendamentoEntity.user ? agendamentoEntity.user.id : ''}</dd>
        </dl>
